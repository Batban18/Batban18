...
Four years across offensive security, compliance, and security operations. I test web applications, APIs, and network infrastructure, validate controls against PCI-DSS and ISO 27001, and work with engineering teams to actually close what I find. Previously a penetration tester at Emedpractice in India.
...
| Repository | Focus | What's inside |
| :--- | :--- | :--- |
| **pentest-report-library** | `Offensive` | Report templates and worked assessments — scoping, CVSS-rated findings, PoC evidence, remediation guidance, retest logs |
| **owasp-labs** | `AppSec` | OWASP Top 10 and API Security Top 10 by vulnerability class — exploitation walkthrough, secure code fix, detection guidance |
| **pci-dss-control-toolkit** | `GRC` | PCI-DSS v4.0 control mapping, PCI ↔ ISO 27001 ↔ NIST CSF crosswalk, gap-assessment templates, evidence-collection scripts |
| **ml-intrusion-detection** | `Research` | Code and notebooks reproducing my published research on ML-based intrusion detection |
| **splunk-detections** | `Blue Team` | SPL detections mapped to MITRE ATT&CK, with tuning notes on cutting alert noise |
| **security-mcp-server** | `AI Security` | MCP server exposing CVE lookup, CVSS scoring, and OWASP references as tools for AI assistants |
...
<table width="100%">
<tr>
<td width="22%"><b>⚔️ Offensive</b></td>
<td>
...
<td>
<img src="https://img.shields.io/badge/PCI--DSS-004B87?style=flat-square&logo=mastercard&logoColor=white"/>
<img src="https://img.shields.io/badge/ISO_27001-0052CC?style=flat-square&logo=iso&logoColor=white"/>
<img src="https://img.shields.io/badge/NIST_CSF-1B365D?style=flat-square&logo=nist&logoColor=white"/>
<img src="https://img.shields.io/badge/SOX-2F4F4F?style=flat-square&logo=bookstack&logoColor=white"/>
...
<table width="100%">
<tr>
<td width="25%" align="center"><b>🎯 CEH</b><br/><sub>EC-Council</sub></td>
<td width="25%" align="center"><b>🛡️ Google Cybersecurity</b><br/><sub>Google / Coursera</sub></td>
<td width="25%" align="center"><b>⚔️ Jr. Penetration Tester</b><br/><sub>TryHackMe · Top 3%</sub></td>
<td width="25%" align="center"><b>🎓 MSc Cybersecurity</b><br/><sub>NYIT Vancouver</sub></td>
</tr>
</table>
